...
print 'Set EB,BB,TB cosmic variance part to zero'
meanCrossSpecNoCV=meanCrossSpec.copy()
for sps in seasonPairs:
    spTag = '%sx%s'%(sps[0],sps[1])
    meanCrossSpecNoCV['BB',spTag]=0*meanCrossSpecNoCV['BB',spTag]
    meanCrossSpecNoCV['EB',spTag]=0*meanCrossSpecNoCV['BB',spTag]
    meanCrossSpecNoCV['BE',spTag]=0*meanCrossSpecNoCV['BB',spTag]
    meanCrossSpecNoCV['TB',spTag]=0*meanCrossSpecNoCV['BB',spTag]
    meanCrossSpecNoCV['BT',spTag]=0*meanCrossSpecNoCV['BB',spTag]
    meanCrossSpecNoCV['TT',spTag]=0*meanCrossSpecNoCV['BB',spTag]
    meanCrossSpecNoCV['TE',spTag]=0*meanCrossSpecNoCV['BB',spTag]
    meanCrossSpecNoCV['ET',spTag]=0*meanCrossSpecNoCV['BB',spTag]
    meanCrossSpecNoCV['EE',spTag]=0*meanCrossSpecNoCV['BB',spTag]
c=0
count1=0
for l1 in fields:
    count1+=1
            ...
            for l4 in fields:
                ...
                for sps in seasonPairs:
                    ...
                    if sps[0]==sps[1] and arrays[0] == arrays[-1]:
                        ...
                        Theta[l1+l2+l3+l4] =meanCrossSpecNoCV[l1+l3,spTag]*meanCrossSpecNoCV[l2+l4,spTag]+meanCrossSpecNoCV[l1+l4,spTag]*meanCrossSpecNoCV[l2+l3,spTag]
                        Theta[l1+l2+l3+l4] += 1./nDivs*(meanCrossSpecNoCV[l1+l3,spTag]*meanNoise_A[l2+l4,spTag]+meanCrossSpecNoCV[l2+l4,spTag]*meanNoise_A[l1+l3,spTag]+meanCrossSpecNoCV[l1+l4,spTag]*meanNoise_A[l2+l3,spTag]+meanCrossSpecNoCV[l2+l3,spTag]*meanNoise_A[l1+l4,spTag])
                        ...
                        Theta[l1+l2+l3+l4] =meanCrossSpecNoCV[l1+l3,spTag]*meanCrossSpecNoCV[l2+l4,spTag]+meanCrossSpecNoCV[l1+l4,spTag]*meanCrossSpecNoCV[l2+l3,spTag]
                        Theta[l1+l2+l3+l4] += 1./nDivs*(meanCrossSpecNoCV[l1+l3,spTag]*meanNoise_B[l2+l4,spTag]+meanCrossSpecNoCV[l2+l4,spTag]*meanNoise_A[l1+l3,spTag]+meanCrossSpecNoCV[l1+l4,spTag]*meanNoise_AB[l2+l3,spTag]+meanCrossSpecNoCV[l2+l3,spTag]*meanNoise_AB[l1+l4,spTag])
                        ...
                        Theta[l1+l2+l3+l4] =meanCrossSpecNoCV[l1+l3,spTag]*meanCrossSpecNoCV[l2+l4,spTag]+meanCrossSpecNoCV[l1+l4,spTag]*meanCrossSpecNoCV[l2+l3,spTag]
                        Theta[l1+l2+l3+l4] +=1./nDivs*(meanCrossSpecNoCV[l1+l3,spTag]*meanNoise_B[l2+l4,spTag]+meanCrossSpecNoCV[l2+l4,spTag]*meanNoise_A[l1+l3,spTag])
